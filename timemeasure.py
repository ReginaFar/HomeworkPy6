...
"""
При вводе чисел 1 2 3 получили следующие значения:
"""
# max_sum - 0.00546270003542304
# max_sum_new - 0.002946999855339527

"""
В новой функции max_sum_new создала список из трех чисел, введенных с клавиатуры, при помощи функции min
нашла минимальное из трех чисел и при помощи функции remove удалила его из списка. Далее при помощи
функции sum нашла сумму двух оставшихся элементов списка.За счет использования встроенных 
функций уменьшилось время выполнения программы.
